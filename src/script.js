...
// Hover animation
function hoverAnimation(wrapper, textAnimation) {
...
// hoverAnimation('text-wrapper', '#text');
hoverAnimation('projects-wrapper', '#projects');
hoverAnimation('profile-wrapper', '#profile');
});